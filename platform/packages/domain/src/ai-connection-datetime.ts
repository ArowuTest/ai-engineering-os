...
function parseBareDateTimeLocal(value: string): string {
  ...
  if (fractional !== undefined) {
    // AI Engineering OS currently exposes usage-window instants through JS Date/ISO,
    // so millisecond precision is the canonical contract. Higher fractional precision
    // is deliberately normalised down to milliseconds here.
